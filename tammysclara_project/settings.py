...
MIDDLEWARE = [
    ...
    'whitenoise.middleware.WhiteNoiseMiddleware', # ✅ LIGA O VISUAL/CSS
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, 'templates'), # ✅ Pasta Raiz
        ],
        'APP_DIRS': True, # ✅ Faz o Django olhar dentro de store/templates/
        'OPTIONS': {
            'context_processors': [
